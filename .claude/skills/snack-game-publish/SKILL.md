...
- `game`: public game metadata object. Generated projects should keep this object; deploy and
  publish require it for `game.titleImage`.
...
- `game.titleImage`: required image under `assets/`, for example `title.svg` or
...
- `game.titleImage` points to an image file under `assets/`.
